...
class PoolsideHeaterGauge extends HTMLElement {
  static getConfigElement() { return document.createElement("poolside-heater-gauge"); }
  static getStubConfig() { return { entity: "climate.poolside_pool_heater" }; }
  ...
  _render() {
    ...
    const input = root.querySelector(".input"); input.value = safeTarget; input.min = min; input.max = max; input.step = attrs.target_temp_step || 1;
